...
db.RateIncrement = require('./rateincrement')(sequelize, Sequelize.DataTypes);
...
db.ProfileContactInformation = require('./profilecontactinformation')(sequelize, Sequelize.DataTypes);
