...
const { ValidateForm } = require('../middlewares/AppointmentStatusValidator');

const { VerifyToken, AuthorizeRoles } = require('../middlewares/AuthMiddleware');

const { GetAll, Create, Update, Disable, Enable } = require('../controllers/AppointmentStatusController');
